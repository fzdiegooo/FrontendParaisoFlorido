...
export default class MisionVisionComponent {
  ...
  class_contenedor = "max-w-xl p-8 bg-white border-2 border-red-700 rounded-lg shadow  "
  ...
  icono2 = "ri-eye-line"
  class_contenedor2 = "max-w-xl p-8 bg-white border-2 border-green-700 rounded-lg shadow "
}
